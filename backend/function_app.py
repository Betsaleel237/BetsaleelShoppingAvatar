...
tools = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "product_name": {
                        "type": "string",
                        "description": "Name of the product to order (i.e., Organic Microgreens, Dragon Fruit, Rose Bouquet, Broccoli Florets)"
                    },
                    "quantity": {
                        "type": "number",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "user_question": {
                        "type": "string",
                        "description": "User question (i.e., what kind of Dragon Fruit do you have?, etc.)"
                    },
                },
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Search the web for questions about recent vegetables, crops or fruits activities related forecasts. Use only if the requested information is not already available in the conversation context.",
            "parameters": {
                "type": "object",
                "properties": {
                    "search_term": {
                        "type": "string",
                        "description": "User question optimized for a web search engine (examples: How will the pollution be like this year? what fruits should people with dianetes eat, etc.)"
                    },
                },
